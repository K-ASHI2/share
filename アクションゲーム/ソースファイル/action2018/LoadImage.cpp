...
void image() {
	...
	//img.haikei[0] = LoadGraph("img/background.png");
	img.haikei[1] = LoadGraph("img/b_cave.png");
	//img.haikei[2] = LoadGraph("img/b_doukutu2.png");
	img.haikei[3] = LoadGraph("img/b_darkcave.png");
	img.haikei[4] = LoadGraph("img/b_check.png");
	img.haikei[5] = LoadGraph("img/b_yuki.png");
	img.haikei[6] = LoadGraph("img/darkcloud.png");
	img.haikei[7] = LoadGraph("img/b_purple.png");
	img.haikei[8] = LoadGraph("img/b_lightred.png");
	//img.haikei[9] = LoadGraph("img/background.png");
	img.haikei[10] = LoadGraph("img/b_red.png");
	...
	img.attack = LoadGraph("img/attack2.png");//çUåÇîªíËÇÃâÊëú(ç°ÇÕégÇ¡ÇƒÇ»Ç¢)
	...
	img.cloud = LoadGraph("img/cloud.png");
	...
	img.playerdamaged = LoadGraph("img/playerdamaged.png");
	...
	img.fish2 = LoadGraph("img/enemy/fish2.png");
